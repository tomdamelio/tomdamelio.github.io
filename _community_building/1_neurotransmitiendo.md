---
layout: page
title: NeuroTransmitiendo
description: Communication and education in human behavior, with a focus on the Latin American context.
img: assets/img/NT_charla.png
importance: 1
category: outreach
---

My career in psychology and neuroscience has always been linked to my passion for effective communication. This led me to co-found [NeuroTransmitiendo](https://www.neurotransmitiendo.org/), a project dedicated to communication and education in human behavior, with a particular focus on the Latin American context.
...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/NT_charla.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Talk on Communication in Neuroscience and Psychology delivered at the University of Buenos Aires, November 2019.
</div>
