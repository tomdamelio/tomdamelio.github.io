...
* Research Intern, University of Buenos Aires (UBA), Argentina
  * Manager and main developer of the project: 
    ...
    * We have implemented a regression pipeline to predict electrodermal and electromiographic activity at the event-level with the data obtained from EEG recordings.
...
* Winner of the Science Abroad 2023 program. University of Buenos Aires. June 2023.
* Winner of a scholarship to assist to "Khipu" (Latin American Meeting In Artificial Intelligence). Universidad de la Republica, Uruguay. March 2023.
* Winner of a scholarship to assist to "Khipu" (Latin American Meeting In Artificial Intelligence). Universidad de la Republica, Uruguay. November 2019.
...
* 2017 Outstanding Student Award of the University of Buenos Aires. December 2018.
* Winner of the Science and Technology University of Buenos Aires (UBACyT) Research Fellowship. September 2018.
...
* Co-founder of [Neurotransmitiendo](https://www.neurotransmitiendo.org/), an Argentinean NGO dedicated to public communication and teaching of neuroscience and psychology in Argentina with a [+20k community.](https://www.instagram.com/neurotransmitiendo/)
  * Designed and executed innovative communication strategies that fostered the growth of our community while ensuring our content was engaging and understandable. This included producing neuroscience content for a variety of platforms, including Instagram and newsletters.
  * Served as a key member of the team for Neurotransmitiendo's science podcast, taking on roles such as interviewer and researcher. My contributions were aimed at making scientific knowledge more accessible to the general public.
  * Was involved in the development of Neurotransmitiendo's visual identity, using visual design elements to reflect our mission to make scientific knowledge not only accessible, but also engaging.
  * Worked to expand partnerships and collaborations with similar organizations to leverage mutual interests and broaden the reach of our educational materials.
...
References
======
* [Dr. Denis A. Engemann](https://denis-engemann.de/ ): denis.engemann@roche.com
* [Dr. Enzo Tagliazucchi](https://scholar.google.com/citations?user=pK7ZGlkAAAAJ&hl=es): enzo@df.uba.ar
* [Dr. Hans Super](https://scholar.google.com/citations?user=psZFvIIAAAAJ&hl=ess): hans.super@icrea.cat